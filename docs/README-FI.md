<p align="center">
  <img src="../res/logo-header.svg" alt="Anuvadini - Etätyöpöytäsi"><br>
...
Juttele meidän kanssa: [Discord](https://discord.gg/nDceKgxnkV) | [Twitter](https://twitter.com/anuvadini) | [Reddit](https://www.reddit.com/r/anuvadini) | [YouTube](https://www.youtube.com/@anuvadini)

[![Anuvadini Server Pro](https://img.shields.io/badge/Anuvadini%20Server%20Pro-Edistyneet%20Ominaisuudet-blue)](https://anuvadini.com/pricing.html)

Vielä yksi etätyöpöytäohjelmisto, ohjelmoitu Rust-kielellä. Toimii suoraan pakkauksesta, ei tarvitse asetusta. Hallitset täysin tietojasi, ei tarvitse murehtia turvallisuutta. Voit käyttää meidän rendezvous/relay-palvelinta, [aseta omasi](https://anuvadini.com/server), tai [kirjoittaa oma rendezvous/relay-palvelin](https://github.com/anuvadini/anuvadini-server-demo).

Anuvadini toivottaa avustukset tervetulleiksi kaikilta. Katso lisätietoja [`docs/CONTRIBUTING.md`](CONTRIBUTING.md) avun saamiseksi.

[**BINAARILATAUS**](https://github.com/anuvadini/anuvadini/releases)
...
- **[libs/hbb_common](https://github.com/anuvadini/anuvadini/tree/master/libs/hbb_common)**: video codec, config, tcp/udp wrapper, protobuf, fs-funktiot tiedostosiirtoon, ja jotkut muut apuohjelmafunktiot
- **[libs/scrap](https://github.com/anuvadini/anuvadini/tree/master/libs/scrap)**: näyttökaappaukset
- **[libs/enigo](https://github.com/anuvadini/anuvadini/tree/master/libs/enigo)**: platform specific keyboard/mouse control
- **[src/ui](https://github.com/anuvadini/anuvadini/tree/master/src/ui)**: Graafinen käyttöliittymä
