...
#[cfg(target_os = "windows")]
const RD_DRIVER_INF_PATH: &str = "drivers/AnuvadiniPrinterDriver/AnuvadiniPrinterDriver.inf";
...
#[cfg(target_os = "windows")]
fn get_port_name(_app_name: &str) -> Vec<u16> {
    "nul:"
        .encode_utf16()
        .chain(Some(0))
        .collect()
