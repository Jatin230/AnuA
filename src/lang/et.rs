...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Anuvadinii võrguga ühendumine..."),
        ...
        ("install_tip", "Kasutajakonto kontrolli (UAC) tõttu ei saa Anuvadini mõnel juhul korralikult kaugjuhtimispoolena töötada. Kontrolli vältimiseks palun klõpsa alloleval nupul, et Anuvadini oma süsteemi paigaldada."),
        ("Click to upgrade", "Vajuta täiendamiseks"),
        ("Configure", "Seadista"),
        ("config_acc", "Töölaua kaugjuhtimiseks tuleb Anuvadiniile anda \"juurdepääsetavuse\" õigused."),
        ("config_screen", "Töölaua kaugjuhtimiseks tuleb Anuvadiniile anda \"ekraanisalvestuse\" õigused."),
        ...
        ("android_input_permission_tip1", "Selleks, et kaugseade saaks sinu Androidi seadet juhtida hiire või puute abil, pead andma Anuvadiniile \"juurdepääsetavuse\" loa."),
        ("android_input_permission_tip2", "Palun mine järgmisele süsteemiseadete lehele, leia ja sisesta [Paigaldatud teenused], lülita teenus [Anuvadini Input] sisse."),
        ...
        ("Language", "Keel"),
        ("Keep Anuvadini background service", "Säilita Anuvadinii taustateenus"),
        ("Ignore Battery Optimizations", "Ignoreeri akuoptimeerimisi"),
        ("android_open_battery_optimizations_tip", "Kui soovid selle funktsiooni keelata, palun mine järgmisele Anuvadinii rakenduse seadete lehele, leia ja sisesta [Aku], eemalda linnuke valikult [Piiramata]"),
        ...
        ("config_input", "Kaugtöölaua klaviatuuriga juhtimiseks pead andma Anuvadiniile \"sisendi jälgimise\" õigused."),
        ("config_microphone", "Kaugelt rääkimiseks pead andma Anuvadiniile \"heli salvestamise\" õigused."),
        ...
        ("still_click_uac_tip", "Kaugkasutaja peab siiski ise vajutama käitatud Anuvadinii kasutajakonto kontrollis (UAC) OK-nuppu."),
        ...
        ("verify_anuvadini_password_tip", "Kinnita Anuvadinii parool"),
        ...
        ("scam_text1", "Kui räägid telefoniga kellegagi, keda EI TUNNE ja EI USALDA, kes on palunud sul Anuvadinii kasutada ja teenus käivitada, ära jätka ning lõpeta kõne koheselt."),
        ...
        ("upgrade_anuvadini_server_pro_to_{}_tip", "Palun täienda Anuvadini Server Pro versioonile {} või uuem!"),
        ...
        ("selinux_tip", "SELinux on su seadmes lubatud, mis võib Anuvadiniil takistada juhitud poolel toimimist."),
        ...
        ("powered_by_me", "Põhineb Anuvadiniil"),
        ...
        ("allow-only-conn-window-open-tip", "Luba ühendus ainult siis, kui Anuvadinii aken on avatud."),
        ...
        ("floating_window_tip", "See aitab säilitada Anuvadinii taustateenust."),
        ...
        ("About Anuvadini", "Anuvadinii teave"),
        ...
        ("upgrade_remote_anuvadini_client_to_{}_tip", "Täiendage Anuvadinii klient kaugküljel versioonile {} või uuemale!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
