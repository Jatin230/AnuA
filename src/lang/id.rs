...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Menghubungkan ke Anuvadini..."),
        ...
        ("install_tip", "Karena UAC, Anuvadini tidak dapat bekerja dengan baik sebagai sisi remote dalam beberapa kasus. Untuk menghindari UAC, silakan klik tombol di bawah ini untuk menginstal Anuvadini ke sistem."),
        ("Click to upgrade", "Klik untuk upgrade"),
        ("Configure", "Konfigurasi"),
        ("config_acc", "Agar bisa mengontrol Desktopmu dari jarak jauh, Kamu harus memberikan izin \"Aksesibilitas\" untuk Anuvadini."),
        ("config_screen", "Agar bisa mengakses Desktopmu dari jarak jauh, kamu harus memberikan izin \"Perekaman Layar\" untuk Anuvadini."),
        ...
        ("android_input_permission_tip1", "Agar perangkat jarak jauh dapat mengontrol perangkat Android melalui mouse atau sentuhan, Kamu harus memberikan izin/permission kd Anuvadini untuk menggunakan layanan \"Aksesibilitas\"."),
        ("android_input_permission_tip2", "Silakan buka halaman pengaturan sistem berikutnya, temukan dan masuk ke [Layanan Terinstal], aktifkan layanan [Input Anuvadini]."),
        ...
        ("Language", "Bahasa"),
        ("Keep Anuvadini background service", "Pertahankan Anuvadini berjalan pada service background"),
        ...
        ("Show Anuvadini", "Tampilkan Anuvadini"),
        ("This PC", "PC ini"),
        ("or", "atau"),
        ("Elevate", "Elevasi"),
        ...
        ("config_input", "Untuk menggunakan input keyboard remote, anda perlu memberikan izin \"Pemantauan Input\" pada Anuvadini"),
        ("config_microphone", "Untuk berbicara secara remote, anda perlu memberikan izin \"Rekam Audio\" pada Anuvadini"),
        ...
        ("still_click_uac_tip", "Masih memerlukan persetujuan pihak pengguna remote untuk mengklik OK pada jendela UAC Anuvadini yang sedang berjalan"),
        ...
        ("verify_anuvadini_password_tip", "Verifikasi Kata Sandi Anuvadini"),
        ...
        ("scam_text1", "Jika anda sedang berbicara di telepon dengan seseorang yang TIDAK dikenal dan mereka meminta anda untuk menggunakan Anuvadini, jangan lanjutkan dan segera tutup panggilan."),
        ...
        ("upgrade_anuvadini_server_pro_to_{}_tip", "Silahkan perbarui Anuvadini Server Pro ke versi {} atau yang lebih baru!"),
        ...
        ("selinux_tip", "pada perangkat anda, SELinux sedang aktif, yang mana itu dapat mencegah Anuvadini berfungsi dengan baik sebagai sisi yang dikontrol."),
        ...
        ("powered_by_me", "Didukung oleh Anuvadini"),
        ...
        ("allow-only-conn-window-open-tip", "Koneksi hanya diperbolehkan jika jendela Anuvadini sedang terbuka."),
        ...
        ("Floating window", ""),
        ("floating_window_tip", "Untuk menjaga layanan/service Anuvadini agar tetap aktif"),
        ...
        ("About Anuvadini", "Tentang Anuvadini"),
        ...
        ("upgrade_remote_anuvadini_client_to_{}_tip", "Silahkan perbarui aplikasi Anuvadini ke versi {} atau yang lebih baru pada komputer yang akan terhubung!"),
