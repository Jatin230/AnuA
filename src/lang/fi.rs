...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Yhdistetään Anuvadini verkkoon..."),
        ...
        ("install_tip", "Joissain tapauksissa Anuvadini ei toimi oikein etäpuolella UAC:n vuoksi. Välttääksesi tämän, napsauta alla olevaa painiketta asentaaksesi Anuvadiniin järjestelmään."),
        ("Click to upgrade", "Päivitä napsauttamalla"),
        ("Configure", "Määritä"),
        ("config_acc", "Etätyöpöydän hallintaa varten sinun on annettava Anuvadiniille ”Esteettömyys”-oikeudet."),
        ("config_screen", "Etätyöpöydän käyttöä varten sinun on annettava Anuvadiniille ”Näytön tallennus” oikeudet."),
        ...
        ("Discovered", "Löydetty"),
        ("install_daemon_tip", "Palvelun automaattista käynnistystä varten Anuvadini daemon on asennettava järjestelmään."),
        ("Remote ID", "Etätunnus"),
        ("Paste", "Liitä"),
        ...
        ("android_input_permission_tip1", "Siirry Androidin asetuksiin ja ota Anuvadiniille käyttöön 'Syötteen ohjaus' oikeus."),
        ("android_input_permission_tip2", "Jos et löydä asetusta, etsi 'Esteettömyys' ja salli Anuvadini ohjelman käyttö."),
        ("android_new_connection_tip", "Uusi yhteyspyyntö vastaanotettu."),
        ("android_service_will_start_tip", "Anuvadini palvelu käynnistyy taustalla."),
        ("android_stop_service_tip", "Pysäytä taustapalvelu tarvittaessa Anuvadiniin asetuksista."),
        ("android_version_audio_tip", "Äänensiirto vaatii Android 10:n tai uudemman."),
        ("android_start_service_tip", "Anuvadini palvelu käynnistetään..."),
        ...
        ("Language", "Kieli"),
        ("Keep Anuvadini background service", "Pidä Anuvadiniin taustapalvelu käynnissä"),
        ("Ignore Battery Optimizations", "Ohita akun optimoinnit"),
        ("android_open_battery_optimizations_tip", "Poista Anuvadiniin akkuoptimointi, jotta yhteys pysyy vakaana taustalla."),
        ...
        ("Show Anuvadini", "Näytä Anuvadini"),
        ...
        ("verify_anuvadini_password_tip", "Vahvista Anuvadini salasanasi kirjautumista varten"),
        ...
        ("scam_text2", "Anuvadini ei koskaan pyydä maksua tai etäkäyttöä ilman lupaasi."),
        ...
        ("upgrade_anuvadini_server_pro_to_{}_tip", "Päivitä Anuvadini Server Pro versioon {} jatkaaksesi."),
        ...
        ("About Anuvadini", "Tietoa Anuvadiniistä"),
        ...
        ("upgrade_remote_anuvadini_client_to_{}_tip", "Päivitä etä-Anuvadini-asiakasversioon {} yhteensopivuuden takaamiseksi"),
