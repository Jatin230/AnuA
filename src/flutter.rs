...
#[cfg(not(windows))]
#[no_mangle]
pub extern "C" fn anuvadini_core_main() -> bool {
    #[cfg(not(any(target_os = "android", target_os = "ios")))]
...
#[cfg(windows)]
#[no_mangle]
pub extern "C" fn anuvadini_core_main_args(args_len: *mut c_int) -> *mut *mut c_char {
...
#[cfg(windows)]
#[no_mangle]
pub unsafe extern "C" fn get_anuvadini_app_name(buffer: *mut u16, length: i32) -> i32 {
...
impl InvokeUiSession for FlutterHandler {
    ...
    fn on_rgba(&self, display: usize, rgba: &mut scrap::ImageRgb) {
        ...
        let sent_texture = self.on_rgba_flutter_texture_render(use_texture_render, display, rgba);
        // Fallback to software render when texture render is enabled but fails to
        // deliver frame notifications. Without this fallback, the UI may remain
        // stuck on "Connected, waiting for image...".
        if !use_texture_render || !sent_texture {
