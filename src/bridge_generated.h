...
void wire_start_localtunnel_host(int64_t port_, uint16_t port);

void wire_stop_localtunnel_host(int64_t port_);
...
static int64_t dummy_method_to_enforce_bundling(void) {
    ...
    dummy_var ^= ((int64_t) (void*) wire_start_localtunnel_host);
    dummy_var ^= ((int64_t) (void*) wire_stop_localtunnel_host);
