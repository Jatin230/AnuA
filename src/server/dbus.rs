...
///
/// Note:
/// On linux, we use dbus to communicate multiple anuvadini process.
...
const DBUS_NAME: &str = "org.anuvadini.anuvadini";
...
impl fmt::Display for DbusError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "Anuvadini DBus Error: {}", self.0)
    }
}
...
/// `dbus-send --session --print-reply --dest=org.anuvadini.anuvadini /dbus org.anuvadini.anuvadini.NewConnection string:'PEER_ID'`
