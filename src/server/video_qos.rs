...
// Constants
pub const FPS: u32 = 60; // Max smoothness for zero-latency feel
pub const MIN_FPS: u32 = 1;
pub const MAX_FPS: u32 = 120;
pub const INIT_FPS: u32 = 60; // Start immediately at high speed

// Bitrate ratio constants for different quality levels
const BR_MAX: f32 = 5.0; // Lowered from 40.0 to prevent Wi-Fi saturation (approx 10Mbps cap)
...
const ADJUST_RATIO_INTERVAL: usize = 1; // Faster adjustment (1 second) for unstable networks
const DYNAMIC_SCREEN_THRESHOLD: usize = 2; // Allow increase quality ratio if encode more than 2 times in one second
const DELAY_THRESHOLD_150MS: u32 = 80; // Very aggressive threshold for extreme responsiveness
        ...
        if let Some(user) = self.users.get_mut(&id) {
            ...
            if avg_delay < 50 {
                ...
                if avg_delay < 200 {
                    ...
                    // Take 4: Trigger immediate bitrate drop if delay is too high
                    adjust_ratio = true;
                }
            }
