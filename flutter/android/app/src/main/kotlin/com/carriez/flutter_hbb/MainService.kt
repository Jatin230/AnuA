...
const val DEFAULT_NOTIFY_TITLE = "Anuvadini"
...
class MainService : Service() {
    ...
    override fun onBind(intent: Intent): IBinder {
        Log.d(logTag, "MainService onBind: action=${intent.action}")
        return binder
    }
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        Log.d(logTag, "MainService onStartCommand: action=${intent?.action}, startId=$startId")
    ...
    private fun initNotification() {
        ...
        notificationChannel = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channelId = "Anuvadini"
            val channelName = "Anuvadini Service"
            val channel = NotificationChannel(
                channelId,
                channelName, NotificationManager.IMPORTANCE_HIGH
            ).apply {
                description = "Anuvadini Service Channel"
            }
