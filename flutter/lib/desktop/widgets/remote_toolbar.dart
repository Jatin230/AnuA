...
class _ToolbarTheme {
  ...
  static const Color chatColor = Color(0xFF0F766E);
  static const Color hoverChatColor = Color(0xFF115E59);
  static const Color displayColor = Color(0xFF7C3AED);
  static const Color hoverDisplayColor = Color(0xFF6D28D9);
  static const Color mobileActionColor = Color(0xFFEA580C);
  static const Color hoverMobileActionColor = Color(0xFFC2410C);
...
class _RemoteToolbarState extends State<RemoteToolbar> {
  ...
  Widget _buildDraggableCollapse(BuildContext context) {
    return Obx(() {
      ...
      return Align(
        alignment: FractionalOffset(1.0, 0.5), // Right edge, vertically centered
        child: Offstage(
  ...
  Widget _buildToolbar(BuildContext context) {
    ...
    final toolbarBorderRadius = BorderRadius.all(Radius.circular(30.0));
    return Column(
      ...
      children: [
        _buildDraggableCollapse(context),
        Material(
          elevation: 12, // More pronounced floating shadow
          shadowColor: MyTheme.color(context).shadow,
          ...
          color: Theme.of(context)
              ...
              .style
              ?.backgroundColor
              ?.resolve(MaterialState.values.toSet())?.withOpacity(0.85), // Glassmorphic
...
class ScreenAdjustor {
  ...
  _getScreenInfoDesktop() async {
    final v = await anuvadiniWinManager.call(
...
class _DisplayMenuState extends State<_DisplayMenu> {
  ...
  Widget build(BuildContext context) {
    ...
    return _IconSubmenuButton(
      ...
      label: 'Display',
      ffi: widget.ffi,
      color: _ToolbarTheme.displayColor,
      hoverColor: _ToolbarTheme.hoverDisplayColor,
  ...
  Widget build(BuildContext context) {
    if (isWeb) {
      ...
      return _IconSubmenuButton(
          tooltip: 'Chat',
          key: chatButtonKey,
          svg: 'assets/chat2.svg',
          label: 'Chat',
          ffi: widget.ffi,
          color: _ToolbarTheme.chatColor,
          hoverColor: _ToolbarTheme.hoverChatColor,
...
class _IconMenuButtonState extends State<_IconMenuButton> {
  ...
  Widget build(BuildContext context) {
    ...
    final bg = hover ? widget.hoverColor : widget.color;
    final iconColor = _ToolbarTheme.iconColorFor(bg);
    ...
    var button = SizedBox(
      width: widget.width ?? (widget.label == null ? _ToolbarTheme.buttonSize : 56),
      height: _ToolbarTheme.buttonSize + (widget.label == null ? 0 : 8),
                    ...
                    decoration: BoxDecoration(
                      borderRadius:
                          BorderRadius.circular(
                              widget.label == null ? _ToolbarTheme.iconRadius : 14),
                      border: Border.all(
...
class _DraggableShowHideState extends State<_DraggableShowHide> {
  ...
  Widget build(BuildContext context) {
    ...
    dockButton(VoidCallback? onPressed, Widget icon,
    ...
    final child = Column(
      ...
      children: [
        ...
        if (isWebDesktop)
          Obx(() {
            if (collapse.isFalse) return Offstage();
            return dockButton(
