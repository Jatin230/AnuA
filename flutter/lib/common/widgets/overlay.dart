        ...
        builder: (_, onPanUpdate) {
          return GestureDetector(
              ...
              child: Card(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                        color: MyTheme.accent.withOpacity(0.65), // Glassmorphic bump
                        boxShadow: [
                            BoxShadow(
                        ...
                        borderRadius:
                            BorderRadius.all(Radius.circular(22 * scale))), // Fully rounded pill
                    child: Column( // Flipped Row to Column
                      ...
                      children: [
                        IconButton(
                            ...
                            icon: const Icon(Icons.arrow_back_ios_new), // Modernized Icon
                            iconSize: 20 * scale),
                        IconButton(
                            color: Colors.white,
                            onPressed: onHomePressed,
                            splashRadius: kDesktopIconButtonSplashRadius,
                            icon: const Icon(Icons.space_dashboard), // Modernized Icon
                            iconSize: 20 * scale),
                        IconButton(
                            color: Colors.white,
                            onPressed: onRecentPressed,
                            splashRadius: kDesktopIconButtonSplashRadius,
                            icon: const Icon(Icons.view_carousel), // Modernized Icon
                            iconSize: 20 * scale),
                        const Divider( // Flipped VerticalDivider
                          height: 0,
                          thickness: 2,
                          indent: 10,
                          endIndent: 10,
                        ...
                        IconButton(
                            ...
                            splashRadius: kDesktopIconButtonSplashRadius,
                            icon: const Icon(Icons.close), // Modernized close
                            iconSize: 20 * scale),
                      ],
                    ),
                  )));
