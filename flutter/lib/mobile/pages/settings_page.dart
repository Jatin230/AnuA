      ...
      enhancementsTiles.insert(
          ...
          SettingsTile.switchTile(
              ...
              title: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(translate('Keep Anuvadini background service')),
...
void showThemeSettings(OverlayDialogManager dialogManager) async {
  var themeModeStr = bind.mainGetLocalOption(key: kCommConfKeyTheme);
  ...
  dialogManager.show((setState, close, context) {
    ...
    return CustomAlertDialog(
      content: Column(children: [
        getRadio(Text(translate('Cyber-Proxy')), 'cyber_proxy', themeModeStr, isOptFixed ? null : setTheme),
        getRadio(Text(translate('Nordic Frost')), 'nordic_frost', themeModeStr, isOptFixed ? null : setTheme),
        getRadio(Text(translate('Legacy Console')), 'legacy_console', themeModeStr, isOptFixed ? null : setTheme),
        getRadio(Text(translate('Obsidian Night')), 'obsidian_night', themeModeStr, isOptFixed ? null : setTheme)
      ]),
    );
  }, backDismiss: true, clickMaskDismiss: true);
}
