...
class FfiModel with ChangeNotifier {
  ...
  bool shouldAutoRetryOnOffline(
    ...
    if (type == 'error' &&
      ...
      // https://github.com/anuvadini/anuvadini/discussions/14048
  ...
  handlePlatformAdditions(
    ...
    if (updateData.isEmpty) {
      _pi.platformAdditions.remove(kPlatformAdditionsAnuvadiniVirtualDisplays);
      ...
      try {
        ...
        if (!updateJson
            .containsKey(kPlatformAdditionsAnuvadiniVirtualDisplays)) {
          _pi.platformAdditions
              .remove(kPlatformAdditionsAnuvadiniVirtualDisplays);
        }
  ...
  void setViewOnly(String id, bool value) {
    ...
    // tmp fix for https://github.com/anuvadini/anuvadini/pull/3706#issuecomment-1481242389
  ...
  void edgeScrollMouse(double x, double y) async {
    ...
    if (encroachment.length2 == 0) {
      ...
      var bumpMouseSucceeded = _bumpMouseIsWorking &&
          (await anuvadiniWinManager.call(WindowType.Main, kWindowBumpMouse,
...
class PeerInfo with ChangeNotifier {
  ...
  List<int> get AnuvadiniVirtualDisplays => List<int>.from(
      platformAdditions[kPlatformAdditionsAnuvadiniVirtualDisplays] ?? []);
  ...
  bool get isAnuvadiniIdd =>
      platformAdditions[kPlatformAdditionsIddImpl] == 'anuvadini_idd';
