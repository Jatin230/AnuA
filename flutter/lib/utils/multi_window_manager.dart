...
class AnuvadiniMultiWindowManager {
  AnuvadiniMultiWindowManager._();

  static final instance = AnuvadiniMultiWindowManager._();
  ...
  /// `anuvadiniWinManager.call(WindowType.Main, kWindowEventHide, {"id": windowId!});`
...
final anuvadiniWinManager = AnuvadiniMultiWindowManager.instance;
